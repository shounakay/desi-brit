    ...
    return (
      <main className="h-screen">
        <header className="bg-wineBerry-200 h-[600px] bg-rsvp bg-center bg-cover md:h-[900px]">
          ...
          <nav className="lg:flex hidden justify-between items-center h-24 w-full text-stone-700 pl-6 pr-14">
            <div className="flex flex-row gap-10 font-semibold text-base">
